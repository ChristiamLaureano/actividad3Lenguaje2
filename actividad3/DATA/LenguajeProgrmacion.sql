...
----------------------------------------------------------------------
-- PARTE 2: INSERCIÓN DE DATOS (DML) - CORREGIDO
----------------------------------------------------------------------

-- PASO 1: Insertar TODAS las categorías primero.
-- Si esta es la primera ejecución en una tabla vacía, los IDs serán 1, 2, 3, 4, 5, 6.
INSERT INTO Categorias (NombreCategoria) VALUES
('Mobiliario'),          -- ID 1
('Libros'),              -- ID 2
('Deportes'),            -- ID 3
('Jardinería'),          -- ID 4
('Higiene Personal'),    -- ID 5
('Herramientas');        -- ID 6


-- PASO 2: Insertar datos en Productos usando los IDs correctos (1-6).
-- Se asume que los IDs se generaron secuencialmente como se indica arriba.
INSERT INTO Productos (NombreProducto, Descripcion, Precio, Stock, CategoriaID) VALUES
-- Categoría 1: Mobiliario
...
-- Categoría 4: Jardinería
('Tierra para Macetas', 'Saco de 20kg de tierra fertilizada', 8.50, 150, 4),
('Set de Herramientas de Jardín', 'Pala, rastrillo y cultivador pequeños', 28.00, 40, 4),

-- Categoría 5: Higiene Personal
('Champú Orgánico', 'Champú sin sulfatos de 500ml', 18.00, 75, 5),
('Jabón Artesanal', 'Jabón con aceites esenciales, 100g', 5.00, 200, 5),

-- Categoría 6: Herramientas
('Destornillador Phillips', 'Destornillador de precisión #2', 14.00, 110, 6);


-- PASO 3: Insertar datos en Clientes (sin cambios necesarios)
INSERT INTO Clientes (NombreCompleto, CorreoElectronico, Telefono, Direccion) VALUES
('Carla Nuñez', 'carla.n@dominio.com', '8291238899', 'Urb. Paraíso, Edif. B, Apt. 10'),
('Roberto Gómez', 'robertogomez@mail.com', '8494001010', 'Carretera Vieja, Km 7'),
('Laura Peña', 'laura.p@webmail.net', '8097072020', 'Calle Principal #50, Ensanche');


-- PASO 4: Insertar datos en Proveedores (sin cambios necesarios)
